...
#define CUSTOM_MACHINE_NAME "ПротоПринт"
...
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.   используется
#define Y_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.   используется
#define Z_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.   используется
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1600, 3200, 1600, 3400 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 30, 12, 30, 15 }
...
#define TWO_ATTEMPS // Второе измерения для большей точности

#if ENABLED(TWO_ATTEMPS)
  #define PROBE_SPEED 7 // мм/с Скорость опускания
  #define PROBE_DIST_SECOND 2 // мм Глубина второго измерения. Если зонд уехал ниже чем глубина первого касания + PROBE_DIST_SECOND, то возможно датчик сломался
  #define PROBE_DIST_SECOND_RETRACT 0.5 // мм Поднятие зонда после первого касания
  #define PROBE_SECOND_SPEED 1 // мм/с Скорость опускания до второго касания
#endif

#ifndef Z_MIN_PROBE_ENDSTOP_INVERTING
  #define Z_MIN_PROBE_ENDSTOP_INVERTING false  // Настройте инверсию
#endif
...
#define SOL1_PIN_INVERTING true
...
#define HOMING_FEEDRATE_MM_M { (20*60), (12*60), (15*60) }
